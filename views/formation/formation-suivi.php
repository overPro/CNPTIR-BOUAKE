...
<head>
    ...
    <!-- Begin SEO tag -->
    <title> Epencia Pay | Suivi des formations </title>
 ...
 <div class="page-section">
             ...
             <form action="http://localhost:81/carte/search/formation/suivi" method="POST" enctype="multipart/form-data">
                
           
                
<center><h1 class="page-title"> Liste des formations suivies </h1></center><br>
            <!-- .card -->
                    <section class="card">
                      <!-- .card-header -->
                      <header class="card-header d-flex">
                        <!-- .dropdown -->
                        <div class="dropdown">
                          <select name="sai_annee" class="btn btn-secondary" ><i class="fas fa-filter mr-1"></i>
                ...
                <div class="form-group ml-auto">
                          <input name="sai_matricule" type="text" class="form-control" placeholder="Matricule" id="tfDefault">
                        </div>
                <?php  } ?>

                <?php if(!empty($_SESSION['role']) and $_SESSION['role']=="Investisseur"){  ?>
                <div class="form-group ml-auto">
                          <input readonly="" name="sai_matricule" type="text" class="form-control" placeholder="Matricule" id="tfDefault" value="<?php echo $_SESSION['matricule']; ?>">
                        </div>
                
                <?php  } ?>
                        
                        <button name="btn_rechercher" class="btn btn-primary ml-auto">Afficher</button>
                      </header><!-- /.card-header -->
                      <!-- .table-responsive -->
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="align-middle"> <?php echo $value['code_diplome']; ?> </td>
                              ...
                              <td class="align-middle">
                                <?php echo $value['date_delivrance']; ?>
                              </td>
