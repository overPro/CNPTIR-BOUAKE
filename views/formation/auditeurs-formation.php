...
<head>
    ...
    <!-- Begin SEO tag -->
    <title> Epencia Pay | Liste des auditeurs </title>
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title"> Liste des auditeurs </h1>
             ...
             <form action="http://localhost:81/carte/search/formation/auditeurs" method="POST" enctype="multipart/form-data">
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="align-middle"> <?php echo $value['signataire']; ?> </td>
                              <td class="align-middle"> <?php echo $value['date_delivrance']; ?> </td>
