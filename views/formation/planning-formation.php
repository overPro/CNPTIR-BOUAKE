...
<head>
    ...
    <!-- Begin SEO tag -->
    <title> Epencia | Planning de formation </title>
...
<center><h1 class="page-title"> Liste des formations de l'année <?php echo date('Y'); ?> </h1></center><br>
            <!-- .card -->
                    <section class="card">
                      <!-- .card-header -->
                      <header class="card-header d-flex">
                        ...
                        <button type="button" class="btn btn-primary ml-auto">Liste des formations effectuées</button>
                      </header><!-- /.card-header -->
                      <!-- .table-responsive -->
...
<!-- Mirrored from uselooper.com/page-clients.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Dec 2018 11:20:42 GMT -->
</html>