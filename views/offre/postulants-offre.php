...
<head>
    ...
    <!-- Begin SEO tag -->
    <title> Epencia Pay | Liste des postulants </title>
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title"> Liste des postulants </h1>
             ...
             <form action="http://localhost:81/carte/search/offre/postulants" method="POST" enctype="multipart/form-data">
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="align-middle"> <?php echo $value['matricule']; ?> </td>
                              
                              <td class="align-middle"> <?php echo $value['date_souscription']; ?> </td>
                              
                              <td>
                                <a href="http://localhost:81/carte/upload/documents/<?php echo $value['piece_jointe']; ?>" type="button" class="btn btn-primary" style="color: white">Telecharger</a>
                              </td>
