...
<head>
    ...
    <!-- Begin SEO tag -->
    <title> Epencia Pay | Offre suivies </title>
   
    <!-- FAVICONS -->
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="http://localhost:81/carte/assets/apple-touch-icon.png">
    <link rel="shortcut icon" href="http://localhost:81/carte/assets/favicon.ico">
...
<center><h1 class="page-title"> Vos postulats </h1></center><br>                     

             <form action="http://localhost:81/carte/search/offre/suivi" method="POST" enctype="multipart/form-data">
            ...
            <!-- .card -->
                    <section class="card">
                      ...
                      <header class="card-header d-flex">
                        <!-- .dropdown -->
                        <div class="dropdown">
                         <button name="btn_stage" class="btn btn-primary ml-auto">Offre de stages</button>
                          <div class="dropdown-arrow"></div>
                        </div><!-- /.dropdown -->
                        
                        <button name="btn_emploi" class="btn btn-danger ml-auto">Offre d'emplois</button>
                      </header><!-- /.card-header -->
                      <!-- .table-responsive -->
                            ...
                            <tr>
                              <td class="align-middle text-truncate">
                                <div class="media align-items-center">
                                  <a href="#!" class="tile bg-pink text-white mr-2">OF</a>
                              ...
                              <td class="align-middle"> <?php echo $value['date_souscription']; ?> </td>
