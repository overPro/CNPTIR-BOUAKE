...
<head>
    ...
    <!-- Begin SEO tag -->
    <title> Epencia Pay | Offre d'stages </title>
 ...
 <div class="page-section">
             ...
             <form action="http://localhost:81/carte/search/offre/stages" method="POST" enctype="multipart/form-data">
                
           
                
<center><h1 class="page-title"> Liste des offres de stages </h1></center><br>
            <!-- .card -->
                    <section class="card">
                      <!-- .card-header -->
                      <header class="card-header d-flex">
                        ...
                        <a href="http://localhost:81/carte/search/offre/emplois" type="button" class="btn btn-danger ml-auto">Offre d'emplois</a>
                      </header><!-- /.card-header -->
                      <!-- .table-responsive -->
