...
<head>
    ...
    <!-- Begin SEO tag -->
    <title> Epencia Pay| Offres disponibles </title>
 ...
 <div class="page-section">
             ...
             <form action="http://localhost:81/carte/search/offre/disponible" method="POST" enctype="multipart/form-data">
                
           
                
<center><h1 class="page-title"> Liste des offres disponibles</h1></center><br>
            <!-- .card -->
                    <section class="card">
                      <!-- .card-header -->
                      <header class="card-header d-flex">
                        ...
                        <button type="button" class="btn btn-primary ml-auto">Liste des emplois</button>
                      </header><!-- /.card-header -->
                      <!-- .table-responsive -->
