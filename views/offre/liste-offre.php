 ...
 <div class="page-section">
                ...
                <div class="section-deck">
                  <!-- .card -->
                    ...
                    <!-- .card-body -->
                    <div class="card-body">
   <center><h1 class="page-title"> Liste des offres </h1></center><br>                   

             <form action="http://localhost:81/carte/search/offre/liste" method="POST" enctype="multipart/form-data">
