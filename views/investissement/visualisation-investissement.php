...
<html lang="en">
  <head>
    <meta  readonly="" name="description" content="Enregistrement des commandes des clients.">
   
    <title>Epencia Pay - Investissement Visualisation</title>
     ...
     <!-- .app-main -->
      <main class="app-main">
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title"> Visualisation des investissements </h1>
        ...
        <form action="http://localhost:81/carte/search/commande/enregistrement" method="POST" class="needs-validation" novalidate="" id="form">
               ...
               <form action="http://localhost:81/carte/search/investissement/visualisation" method="POST" class="needs-validation" novalidate="" id="form">
                      <!-- .form-row -->
                      <div class="form-row">
                        <!-- form grid -->
                        <div class="col-md-3 mb-3">
                          <label>Numero du contrat</label> 
          <input type="text" class="form-control"  readonly="" name="sai_numero_contrat" value="<?php echo $numero_contrat;  ?>">
                        </div><!-- /form grid -->
                        <!-- form grid -->
                        <div class="col-md-3 mb-3">
                          <label>Matricule</label> 
           <input type="text" class="form-control"   readonly="" name="sai_matricule" value="<?php echo $matricule;  ?>">
                        </div><!-- /form grid -->
                        <div class="col-md-3 mb-3">
                           <label>Capital</label> 
         <input type="text" class="form-control"  readonly="" name="sai_capital" value="<?php echo $capital;  ?>">
                        </div>
                        <div class="col-md-3 mb-3">
                           <label>Taux mensuel</label> 
          <input type="text" class="form-control"   readonly="" name="sai_taux_mensuel" value="<?php echo $taux_mensuel;  ?>">
                        </div>
                        <!-- form grid -->
                        <div class="col-md-3 mb-3">
                          <label>Echeancier mensuel</label> 
          <input type="text" class="form-control"  readonly="" name="sai_echeancier_mensuel" value="<?php echo $echeancier_mensuel;  ?>">
                        </div><!-- /form grid -->
                        <div class="col-md-3 mb-3">
                          <label>Taux annuel</label> 
          <input type="text" class="form-control"  readonly="" name="sai_taux_annuel" value="<?php echo $taux_annuel;  ?>">
                        </div><!-- /form grid -->
                        <div class="col-md-3 mb-3">
                          <label>Echeancier annuel</label> 
          <input type="text" class="form-control"  readonly="" name="sai_echeancier_annuel" value="<?php echo $echeancier_annuel;  ?>">
                        </div>
                        <div class="col-md-3 mb-3">
                          <label>Solde final</label> 
          <input type="text" class="form-control"   readonly="" name="sai_solde_final" value="<?php echo $solde_final;  ?>">
                        </div>
                      </div><!-- /.form-row -->
                      <!-- .form-row -->
                      <div class="form-row">
                        <!-- grid column -->
                        <div class="col-md-3 mb-3">
                          <label>Duree du contrat </label> <input type="text" class="form-control"   readonly="" name="sai_duree_contrat" value="<?php echo $duree_contrat;  ?>">
                          
                        </div><!-- /grid column -->
                        <!-- grid column -->
                        <div class="col-md-3 mb-3">
                          <label>Frequence de paiement </label> 
                          <input type="text" class="form-control"   readonly="" name="sai_frequence_paiement" value="<?php echo $frequence_paiement;  ?>">
                          
                        </div><!-- /grid column -->
                        <!-- grid column -->
                        <div class="col-md-3 mb-3">
                          <label>Etat du capital</label>
                          <input type="text" <input type="text" class="form-control"  readonly="" name="sai_etat_capital" value="<?php echo $etat_capital;  ?>">
                          
                        </div><!-- /grid column -->
                        <div class="col-md-3 mb-3">
                          <label>Etat de l'investissement</label>
                          <input type="text" class="form-control"   readonly="" name="sai_etat_investissement" value="<?php echo $etat_investissement;  ?>">
          ...
          <input type="date" class="form-control"  readonly="" name="sai_date_versement1" value="<?php echo $date_versement1;  ?>">
                        </div><!-- /grid column -->
                        <!-- grid column -->
                        <div class="col-md-3 mb-3">
                          <label>Montant du 1er versement</label> 
          <input type="text" class="form-control"  readonly="" name="sai_montant_versement1" value="<?php echo $montant_versement1;  ?>">
                          
                        </div><!-- /grid column -->
                        <!-- grid column -->
                        <div class="col-md-3 mb-3">
                         <label>Etat du 1e versement</label> 
          <input   readonly="" name="sai_etat_versement1" type="text" class="form-control" value="<?php echo $etat_versement1; ?>">
                          
                        </div><!-- /grid column -->
                        <div class="col-md-3 mb-3">
                          <label>Date du 2e versement</label> 
          <input type="date" class="form-control"  readonly="" name="sai_date_versement2" value="<?php echo $date_versement2;  ?>">
                        </div>
                      </div>
                      <div class="form-row">
                        <!-- grid column -->
          ...
          <input type="text" class="form-control"  readonly="" name="sai_montant_versement2" value="<?php echo $montant_versement2;  ?>">
                          
                        </div><!-- /grid column -->
                        <!-- grid column -->
                        <div class="col-md-3 mb-3">
                         <label>Etat du 2e versement</label> 
          <input   readonly="" name="sai_etat_versement2" type="text" class="form-control" value="<?php echo $etat_versement2; ?>">
                          
                        </div><!-- /grid column -->
                        <div class="col-md-3 mb-3">
                          <label>Date du 3e versement</label> 
          <input type="date" class="form-control"  readonly="" name="sai_date_versement3" value="<?php echo $date_versement3;  ?>">
                        </div>
                        <div class="col-md-3 mb-3">
                          <label>Montant du 3e versement</label> 
          <input type="text" class="form-control"  readonly="" name="sai_montant_versement3" value="<?php echo $montant_versement3;  ?>">
                        </div>
                      </div>
          ...
          <input   readonly="" name="sai_etat_versement3" type="text" class="form-control" value="<?php echo $etat_versement3; ?>">
                          
                        </div><!-- /grid column -->
                        <!-- grid column -->
                        <div class="col-md-3 mb-3">
                         <label>Date du 4e versement</label> 
          <input type="date" class="form-control"  readonly="" name="sai_date_versement4" value="<?php echo $date_versement4;  ?>">
                          
                        </div><!-- /grid column -->
                        <div class="col-md-3 mb-3">
                          <label>Montant du 4e versement</label> 
          <input type="text" class="form-control"  readonly="" name="sai_montant_versement4" value="<?php echo $montant_versement4;  ?>">
                        </div>
                        <div class="col-md-3 mb-3">
                          <label>Etat du 4e versement</label> 
          <input   readonly="" name="sai_etat_versement4" type="text" class="form-control" value="<?php echo $etat_versement4; ?>">
                        </div>
                      </div>
          ...
          <input type="date" class="form-control"  readonly="" name="sai_date_versement5" value="<?php echo $date_versement5;  ?>">
                          
                        </div><!-- /grid column -->
                        <!-- grid column -->
                        <div class="col-md-3 mb-3">
                         <label>Montant du 5e versement</label> 
          <input type="text" class="form-control"  readonly="" name="sai_montant_versement5" value="<?php echo $montant_versement5;  ?>">
                          
                        </div><!-- /grid column -->
                        <div class="col-md-3 mb-3">
                           <label>Etat du 5e versement</label> 
          <input   readonly="" name="sai_etat_versement5" type="text" class="form-control" value="<?php echo $etat_versement5; ?>">
                        </div>
                        <div class="col-md-3 mb-3">
                          <label>Date du 6e versement</label> 
          <input type="date" class="form-control"  readonly="" name="sai_date_versement6" value="<?php echo $date_versement6;  ?>">
                        </div>
                      </div>
          ...
          <input type="text" class="form-control"  readonly="" name="sai_montant_versement6" value="<?php echo $montant_versement6;  ?>">
                          
                        </div><!-- /grid column -->
                        <!-- grid column -->
                        <div class="col-md-3 mb-3">
                         <label>Etat du 6e versement</label> 
          <input   readonly="" name="sai_etat_versement6" type="text" class="form-control" value="<?php echo $etat_versement6; ?>">
                          
                        </div><!-- /grid column -->
                        <div class="col-md-3 mb-3">
                          <label>Date du 7e versement</label> 
          <input type="date" class="form-control"  readonly="" name="sai_date_versement7" value="<?php echo $date_versement7;  ?>">
                        </div>
                        <div class="col-md-3 mb-3">
                          <label>Montant du 7e versement</label> 
          <input type="text" class="form-control"  readonly="" name="sai_montant_versement7" value="<?php echo $montant_versement7;  ?>">
                        </div>
                      </div>
          ...
          <input   readonly="" name="sai_etat_versement7" type="text" class="form-control" value="<?php echo $etat_versement7; ?>">
                          
                        </div><!-- /grid column -->
                        <!-- grid column -->
                        <div class="col-md-3 mb-3">
                         <label>Date du 8e versement</label> 
          <input type="date" class="form-control"  readonly="" name="sai_date_versement8" value="<?php echo $date_versement8;  ?>">
                          
                        </div><!-- /grid column -->
                        <div class="col-md-3 mb-3">
                          <label>Montant du 8e versement</label> 
          <input type="text" class="form-control"  readonly="" name="sai_montant_versement8" value="<?php echo $montant_versement8;  ?>">
                        </div>
                        <div class="col-md-3 mb-3">
                          <label>Etat du 8e versement</label> 
          <input type="text" class="form-control"  readonly="" name="sai_etat_versement8" value="<?php echo $etat_versement8;  ?>">
                        </div>
          ...
          <input type="date" class="form-control"  readonly="" name="sai_date_versement9" value="<?php echo $date_versement9;  ?>">
        </div>
                        
                        <div class="col-md-3 mb-3">
                          <label>Montant du 9e versement</label> 
          <input type="text" class="form-control"  readonly="" name="sai_montant_versement9" value="<?php echo $montant_versement9;  ?>">
                          
                        </div><!-- /grid column -->
                        <!-- grid column -->
                        <div class="col-md-3 mb-3">
                         <label>Etat du 9e versement</label> 
          <input   readonly="" name="sai_etat_versement9" type="text" class="form-control" value="<?php echo $etat_versement9; ?>">
                          
                        </div><!-- /grid column -->
                        <div class="col-md-3 mb-3">
                          <label>Date du 10e versement</label> 
          <input type="date" class="form-control"  readonly="" name="sai_date_versement10" value="<?php echo $date_versement10;  ?>">
                        </div>
          ...
          <input type="text" class="form-control"  readonly="" name="sai_montant_versement10" value="<?php echo $montant_versement10;  ?>">
                          
                        </div>
                        <div class="col-md-3 mb-3">
                         <label>Etat du 10e versement</label> 
          <input   readonly="" name="sai_etat_versement10" type="text" class="form-control" value="<?php echo $etat_versement10; ?>">
                          
                        </div><!-- /grid column -->
                        <div class="col-md-3 mb-3">
                          <label>Date du 11e versement</label> 
          <input type="date" class="form-control"  readonly="" name="sai_date_versement11" value="<?php echo $date_versement11;  ?>">
                        </div>
                        <div class="col-md-3 mb-3">
                          <label>Montant du 11e versement</label> 
          <input type="text" class="form-control"  readonly="" name="sai_montant_versement11" value="<?php echo $montant_versement11;  ?>">
                        </div>
          ...
          <input type="date" class="form-control"  readonly="" name="sai_date_versement12" value="<?php echo $date_versement12;  ?>">
           </div>

          <div class="col-md-3 mb-3">
                          <label>Montant du 12e versement</label> 
          <input type="text" class="form-control"  readonly="" name="sai_montant_versement12" value="<?php echo $montant_versement12;  ?>">
                        </div>

                        <div class="col-md-3 mb-3">
                         <label>Etat du 12e versement</label> 
          <input   readonly="" name="sai_etat_versement12" type="text" class="form-control" value="<?php echo $etat_versement12; ?>">
                        </div><!-- /grid column -->
          ...
          <input type="text" class="form-control"  readonly="" name="sai_part_entreprise" value="<?php echo $part_entreprise;  ?>">
           </div>
       </div>
