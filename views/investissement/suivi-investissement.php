...
<head>
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title"> Comptabilité des investissements </h1>
 ...
 <div class="page-section">
             ...
             <form action="http://localhost:81/carte/search/investissement/suivi" method="POST" enctype="multipart/form-data">
                 ...
                 <?php 
                                        ...
                                        foreach ($sol as $key => $value) { ?>
                                         ...
                                         <td><?php echo $value['numero_contrat']; ?></td>
                                                ...
                                                <td><?php echo $value['date_versement1']; ?></td>
                                                <td><?php echo $value['date_versement12']; ?></td>
                                                <td><?php echo $value['matricule']; ?></td>
                                                <td><?php echo $value['etat_investissement']; ?></td>
                                                
                                                <td><a class="btn btn-outline-danger" href="http://localhost:81/carte/search/investissement/enregistrement&numero_contrat=<?php echo $value['numero_contrat']; ?>">Visualiser</a></td>
