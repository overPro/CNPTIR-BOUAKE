...
<head>
    ...
    <!-- Begin SEO tag -->
    <title> Epencia Pay |  Comptabilité des epargnes </title>
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title"> Comptabilité des epargnes </h1>
 ...
 <div class="page-section">
             ...
             <form action="http://localhost:81/carte/search/epargne/suivi" method="POST" enctype="multipart/form-data">
                ...
                <tbody>
                  <?php 
                                        ...
                                        foreach ($sol as $key => $value) { ?>
                                            ...
                                            <tr>
                                         <td><?php echo $value['code_epargne']; ?></td>
                                                ...
                                                <td><a class="btn btn-outline-danger" href="http://localhost:81/carte/search/epargne/enregistrement&code_epargne=<?php echo $value['code_epargne']; ?>">Visualiser</a></td>
