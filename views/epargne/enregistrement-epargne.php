...
<head>
    ...
    <!-- Begin SEO tag -->
    <title> Epencia Pay | epargne - Enregistrement </title>
    ...
    <div class="app">
      ...
      <main class="app-main">
        ...
        <div class="wrapper">
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title"> Saisie des epargnes </h1>
             ...
             <form action="http://localhost:81/carte/search/epargne/enregistrement" method="POST" enctype="multipart/form-data">
                <center>
                                    <div class="row">
                                    <div class="col-lg-12"> 
          ...
          <input name="sai_code_epargne" type="text" class="form-control" value="<?php echo $code_epargne; ?>">
                </div>

                <div class="form-group">
                  <label>Type epargne</label> 
          <input name="sai_type_epargne" type="text" class="form-control" value="<?php echo $type_epargne; ?>">
                </div>
          ...
          <input name="sai_heure_creation" type="time" class="form-control" value="<?php echo $heure_creation; ?>">
                ...
                <div class="form-group">
                  <label>Montant</label> 
          <input name="sai_montant_epargne" type="text" class="form-control" value="<?php echo $montant_epargne; ?>"> 
                </div>
          ...
          <input name="sai_part_client" type="text" class="form-control" value="<?php echo $part_client; ?>"> 
                </div>
                <div class="form-group">
                  <label>Date debut</label> 
          <input name="sai_date_debut" type="text" class="form-control" value="<?php echo $date_debut; ?>">
                </div>
                <div class="form-group">
                  <label>Date fin</label> 
          <input name="sai_date_fin" type="text" class="form-control" value="<?php echo $date_fin; ?>"> 
                </div>

                <div class="form-group">
                  <label>Duree</label> 
          <input name="sai_duree" type="text" class="form-control" value="<?php echo $duree; ?>">
                </div>
                <div class="form-group">
                  <label>Etat epargne</label> 
          <input name="sai_etat_epargne" type="text" class="form-control" value="<?php echo $etat_epargne; ?>"> 
                </div>
