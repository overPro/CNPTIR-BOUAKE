...
<!-- Mirrored from uselooper.com/user-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Dec 2018 11:20:39 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
      ...
      <header class="app-header app-header-dark">
        ...
        <div class="top-bar">
          ...
          <div class="top-bar-brand">
            <a href="index-2.html"><img src="assets/images/brand-inverse.png" alt="" style="height: 32px;width: auto;"></a>
          </div><!-- /.top-bar-brand -->
          <!-- .top-bar-list -->
            ...
            <nav class="page-navs">
              ...
              <div class="nav-scroller">
                ...
                <div class="nav nav-center nav-tabs">
                  <a class="nav-link active" href="user-profile.html">Overview</a> <a class="nav-link" href="user-activities.html">Activities <span class="badge">16</span></a> <a class="nav-link" href="user-teams.html">Teams</a> <a class="nav-link" href="user-projects.html">Projects</a> <a class="nav-link" href="user-tasks.html">Tasks</a> <a class="nav-link" href="user-profile-settings.html">Settings</a>
                </div><!-- /.nav -->
              </div><!-- /.nav-scroller -->
            </nav><!-- /.page-navs -->
            <!-- .page-inner -->
                ...
                <div class="row">
                  ...
                  <div class="col-xl-4">
                    ...
                    <section class="card card-fluid">
                      <!-- .card-header -->
                      <header class="card-header"> Overview </header><!-- /.card-header -->
                      <!-- .card-body -->
                      <div class="card-body">
                      ...
                      <header class="card-header border-0">
                        ...
                        <div class="d-flex align-items-center">
                          ...
                          <div class="card-header-control">
                            <!-- .dropdown -->
                            <div class="dropdown">
                              <button type="button" class="btn btn-icon btn-light" data-toggle="dropdown" aria-haspoppup="true" aria-expanded="false"><i class="fa fa-fw fa-ellipsis-v"></i></button>
...
<!-- Mirrored from uselooper.com/user-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Dec 2018 11:20:41 GMT -->
</html>