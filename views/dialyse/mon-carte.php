...
<head>
    ...
    <!-- Begin SEO tag -->
    <title> Epencia Pay | Carte - Visualisation </title>
        ...
        <div class="wrapper">
          ...
          <div class="page">
            ...
            <div class="page-inner">
             ...
             <form action="http://localhost:81/carte/search/carte/visualisation" method="POST" enctype="multipart/form-data">
          ...
          <input  readonly="" id="numero_carte" name="sai_numero_carte" type="text" class="form-control" value="<?php echo $numero_carte; ?>">
                </div>

                <div class="form-group">
                 <label>CVV carte</label> 
          <input readonly="" name="sai_cvv_carte" type="text" class="form-control" value="<?php echo $cvv_carte; ?>"> 
                </div>

                <div class="form-group">
                 <label>Nom de carte</label> 
          <input readonly="" name="sai_nom_carte" type="text" class="form-control" value="<?php echo $nom_carte; ?>"> 
                </div>

                <div class="form-group">
                  <label>Type de carte</label> 
           <input readonly="" name="sai_type_carte" class="form-control" value="<?php echo $type_carte; ?>">
                    
                </div>

                <div class="form-group">
                 <label>Solde du carte</label> 
          <input readonly="" name="sai_solde_carte" type="text" class="form-control" value="<?php echo $solde_carte; ?>"> 
                </div>

                <div class="form-group">
                 <label>Devise de carte</label> 
          <input readonly="" name="sai_devise_carte" type="text" class="form-control" value="<?php echo $devise_carte; ?>"> 
                </div>
          ...
          <input readonly="" name="sai_date_expiration" type="date" class="form-control" value="<?php echo $date_expiration; ?>"> 
                </div>
  ...
  <div class="form-group">
          ...
          <input readonly="" name="sai_pays_carte" type="text" class="form-control" value="<?php echo $pays_carte; ?>"> 
                </div>
...
<div class="form-group">
                  ...
                  <input readonly="" name="sai_etat_carte" class="form-control" value="<?php echo $etat_carte; ?>">
