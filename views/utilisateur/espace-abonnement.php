...
<head>
    ...
    <!-- Begin SEO tag -->
    <title> Epencia.net | Abonnement </title>
        ...
        <div class="wrapper">
          ...
          <div class="page">
            ...
            <div class="page-inner">
             ...
             <form action="http://localhost:81/carte/search/utilisateur/abonnement" method="POST" enctype="multipart/form-data">
         ...
         <input  name="sai_nom_prenom" type="text"  class="form-control">
...
<div class="col-12 col-lg-6">
         ...
         <input  name="sai_telephone" type="text"  class="form-control">
            ...
            <div class="tile-footer">
              <button class="btn btn-success" name="btn_ajouter"><i class="fa fa-fw fa-lg fa-check-circle"></i>Creer un compte</button>
            </div>
            </center>
