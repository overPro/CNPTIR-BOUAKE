...
<head>
    ...
    <!-- Begin SEO tag -->
    <title> Epencia Pay | Recharge - Transfert </title>
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title"> Transfert de fonds </h1>
                ...
                <div class="section-deck">
                  ...
                  <section class="card card-fluid">
                    ...
                    <div class="card-body">
                      ...
                      <h6 class="card-subtitle mb-4"> Transfert de fonds vers les comptes virtuels </h6>

             <form action="http://localhost:81/carte/search/recharge/transfert" method="POST" enctype="multipart/form-data">
              ...
              <?php if(!empty($_SESSION['role']) and $_SESSION['role']=="Superviseur" or $_SESSION['role']=="Administrateur") {  ?>
                  ...
                  <div class="form-group">
                    <fieldset>                   
                      <label>Matricule expediteur</label> 
              <input  name="sai_expediteur" type="text" class="form-control">     
                    </fieldset>
                  </div> 
                </div>
               <?php  } ?>

                <?php if(!empty($_SESSION['role']) and $_SESSION['role']=="Investisseur" or $_SESSION['role'] == 'Distributeur') {  ?>
                <div class="col-12 col-lg-3">
                  <div class="form-group">
                    <fieldset>                   
                      <label>Matricule expediteur</label> 
              <input readonly="" name="sai_expediteur" type="text" class="form-control" value="<?php echo $_SESSION['matricule']; ?>">
              ...
              <?php  } ?> 
               ...
               <div class="col-12 col-lg-3">
                  <div class="form-group">
                     ...
                     <label>Matricule destinataire</label> 
         <input  name="sai_destinataire" type="text"  class="form-control">
...
<div class="col-12 col-lg-3">
                  <div class="form-group">
                     ...
                     <label>Montant</label> 
         <input  name="sai_montant" type="text"  class="form-control">
         ...
         <input  name="sai_code_confirmation" type="text"  class="form-control">
            ...
            <div class="tile-footer">
              <button class="btn btn-success" name="btn_ajouter"><i class="fa fa-fw fa-lg fa-check-circle"></i>Envoyer</button>
            </div>
            </center>
