...
<head>
    ...
    <!-- Begin SEO tag -->
    <title> Epencia Pay | Rechargement de carte </title>
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title"> Rechargement de carte </h1>
             ...
             <form action="http://localhost:81/carte/search/recharge/validation" method="POST" enctype="multipart/form-data">
...
<div class="row">
          ...
          <input name="sai_matricule" type="text" class="form-control" placeholder="Saisir le matricule à recharger"> 
                </div>
                <?php  } ?>
          ...
          <input readonly="" name="sai_matricule" type="text" class="form-control" value="<?php echo $_SESSION['matricule']; ?>"> 
                ...
                <?php  } ?>
                <div class="form-group col-md-12">
                  <label>Code de la recharge</label> 
         <input name="sai_code_recharge" class="form-control" type="text" placeholder="Entrez le code de la recharge" value="<?php echo $code_recharge; ?>">
                </div>
