...
<head>
    ...
    <!-- Begin SEO tag -->
    <title> Epencia Pay | Imprimé des recharges </title>
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title"> Imprimés des cartes de recharge </h1>
             ...
             <form action="http://localhost:81/carte/search/recharge/imprime" method="POST" enctype="multipart/form-data">
                <center>
                                    <div class="row">
                                    <div class="col-lg-12"> 
                                        <div class="form-group">
                                            
                                    <button class="btn btn-warning" name="btn_imprimer" style="color: white"><i class="fa fa-fw fa-lg fa-print"></i> Imprimer</button>     
                                        </div>
                                    </div>
                                </div>
