...
<head>
    ...
    <!-- Begin SEO tag -->
    <title> Epencia Pay |  Comptabilité des recharges </title>
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title"> Comptabilité des recharges </h1>
 ...
 <div class="page-section">
             ...
             <form action="http://localhost:81/carte/search/recharge/suivi" method="POST" enctype="multipart/form-data">
...
<section class="card card-fluid">
                  ...
                  <tr>
                                            ...
                                            <th>Nombre actif</th>
                                            <th>Somme actif</th>
                                            <th>Nombre inactif</th>
                                            <th>Somme inactif</th>
                                            <th>Nombre vendu</th>
                                            <th>Somme vendu</th>
                                            <th>Nombre non vendu</th>
                                            <th>Somme non vendu</th>
                ...
                <tbody>
                                            ...
                                            <tr>
                                                <td><?php if(!empty($NombreActif)){ echo $NombreActif[0]['a'];} ?></td>
                                                <td><?php if(!empty($SommeActif)){ echo $SommeActif[0]['a'] ;} ?></td>
                                                <td><?php if(!empty($NombreInactif)){ echo $NombreInactif[0]['a'];} ?></td>
                                                <td><?php if(!empty($SommeInactif)){ echo $SommeInactif[0]['a'] ;} ?></td>
                                                <td><?php if(!empty($NombreVendu)){ echo $NombreVendu[0]['a'] ;} ?></td>
                                                <td><?php if(!empty($SommeVendu)){ echo $SommeVendu[0]['a'] ;} ?></td>
                                                <td><?php if(!empty($NombreNonVendu)){ echo $NombreNonVendu[0]['a'] ;} ?></td>
                                                <td><?php if(!empty($SommeNonVendu)){ echo $SommeNonVendu[0]['a'] ;} ?></td>
                 ...
                 <?php 
                                        ...
                                        foreach ($sol as $key => $value) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $value['etat_validation']; ?></td>
                                                <td><?php echo $value['code_agent']; ?></td>
                                                <td><?php echo $value['matricule']; ?></td>
                                           
                                                <td><a class="btn btn-outline-danger" href="http://localhost:81/carte/search/recharge/enregistrement&code=<?php echo $value['code_recharge']; ?>">Visualiser</a></td>
