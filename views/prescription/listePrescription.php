          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title"> Liste des prescriptions</h1>
              ...
              <div class="card">
                <div class="card-header">
                  <form method="POST" action="http://localhost:81/CNPTIR-BOUAKE/search/bilan/liste">
                <button class="btn btn-primary" type="submit" name="btn_ToutImprimer" style="margin-left: 91%;">IMPRIMER</button>
