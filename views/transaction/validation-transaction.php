...
<head>
    ...
    <!-- Begin SEO tag -->
    <title> Epencia Pay |  Validation des transactions </title>
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title"> Validation des transactions </h1>
 ...
 <div class="page-section">
             ...
             <form action="http://localhost:81/carte/search/transaction/validation" method="POST" enctype="multipart/form-data">
          ...
          <input name="sai_date_transaction" type="date" class="form-control">
                </div>
                </div>
