          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title"> Traitement des retraits</h1>
                 ...
                 <?php 
                                        ...
                                        foreach ($sol as $key => $value) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="http://localhost:81/carte/search/transaction/enregistrement&numero=<?php echo $value['numero_transaction']; ?>"  class="btn btn-success" name="btn_ajouter"><i class="fa fa-fw fa-lg fa-check-circle"></i>Valider</a></td>
