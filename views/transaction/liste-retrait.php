...
<head>
    ...
    <!-- Begin SEO tag -->
    <title> Epencia Pay|  Liste des retraits  </title>
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title">  Liste des retraits  </h1>
 ...
 <div class="page-section">
             ...
             <form action="http://localhost:81/carte/search/transaction/retraits" method="POST" enctype="multipart/form-data">
                 ...
                 <?php 
                                        ...
                                        foreach ($sol as $key => $value) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $value['objet_transaction']; ?></td>
                                                
                                                <td class="align-middle">
                                <?php if(!empty($value['etat_transaction']) and $value['etat_transaction']=="Succes"){ ?>
                                  <span class="badge badge-success"> Succes</span>
                                  <?php
                                } if(!empty($value['etat_transaction']) and $value['etat_transaction']=="Echec"){

                                ?>
                                <span class="badge badge-danger"> Echec</span>
                                  <?php  } if(!empty($value['etat_transaction']) and $value['etat_transaction']=="En attente"){
