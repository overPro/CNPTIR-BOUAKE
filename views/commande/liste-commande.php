              ...
              <div class="page-section">
                ...
                <tbody>
                  <?php 
                    ...
                    <td><a href="http://localhost:81/carte/search/commande/enregistrement&numero_commande=<?php echo $value['numero_commande']; ?>" class="btn btn-outline-danger">Visualiser</a></td>
