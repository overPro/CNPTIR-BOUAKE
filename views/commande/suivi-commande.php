...
<head>
    ...
    <!-- Begin SEO tag -->
    <title> Epencia Pay |  Comptabilité des investissements </title>
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title"> Comptabilité des commandes </h1>
 ...
 <div class="page-section">
             ...
             <form action="http://localhost:81/carte/search/commande/suivi" method="POST" enctype="multipart/form-data">
                 ...
                 <?php 
                                        ...
                                        foreach ($sol as $key => $value) { ?>
                                         ...
                                         <td><?php echo $value['numero_commande']; ?></td>
                                                ...
                                                <td><?php echo $value['frais_livraison']; ?></td>
                                                <td><?php echo $value['montant_total']; ?></td>
                                                <td><?php echo $value['adresse_livraison']; ?></td>
                                                <td><?php echo $value['epargne']; ?></td>
                                                <td><?php echo $value['matricule']; ?></td>
                                                <td><?php echo $value['etat_commande']; ?></td>
                                                
                                                <td><a class="btn btn-outline-danger" href="http://localhost:81/carte/search/commande/enregistrement&numero_commande=<?php echo $value['numero_commande']; ?>">Visualiser</a></td>
