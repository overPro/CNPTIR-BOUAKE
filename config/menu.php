      <header class="app-header app-header-dark">
        ...
        <div class="top-bar">
          ...
          <div class="top-bar-brand bg-transparent">
            ...
            <a href="http://localhost:81/carte/" >Epencia Pay</a>
          </div><!-- /.top-bar-brand -->
          <!-- .top-bar-list -->
          <div class="top-bar-list">
            ...
            <div class="top-bar-item px-2 d-md-none d-lg-none d-xl-none">
              <!-- toggle menu -->
              <button class="hamburger hamburger-squeeze" type="button" data-toggle="aside" aria-label="Menu" aria-controls="navigation"><span class="hamburger-box"><span class="hamburger-inner"></span></span></button> <!-- /toggle menu -->
            </div><!-- /.top-bar-item -->
            <!-- .top-bar-item -->
            ...
            <div class="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
              ...
              <!-- .btn-account -->
              <div class="dropdown">
                <button class="btn-account d-none d-md-flex" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="user-avatar user-avatar-md"><img src="http://localhost:81/carte/assets/epencia.jpg" alt=""></span> <span class="account-summary pr-lg-4 d-none d-lg-block"><span class="account-name">Menu Principal</span> <span class="account-description">Epencia Manager</span></span></button>
                <div class="dropdown-arrow dropdown-arrow-left"></div><!-- .dropdown-menu -->
                <div class="dropdown-menu">
                  <h6 class="dropdown-header d-none d-md-block d-lg-none"> Menu Principal </h6><a class="dropdown-item" href="http://localhost:81/carte/search/utilisateur/connexion"><span class="dropdown-icon oi oi-person"></span> Connexion</a> <a class="dropdown-item" href="auth-signin-v1.html"><span class="dropdown-icon oi oi-account-logout"></span> Logout</a>
                  <div class="dropdown-divider"></div><a class="dropdown-item" href="#!">+225 09107849</a> <a class="dropdown-item" href="#!">Email : </a> <a class="dropdown-item" href="#!">Documentation</a>
                </div><!-- /.dropdown-menu -->
              </div><!-- /.btn-account -->
            </div><!-- /.top-bar-item -->
          </div><!-- /.top-bar-list -->
      ...
      <aside class="app-aside app-aside-light">
        ...
        <div class="aside-content">
          ...
          <header class="aside-header">
            ...
            <button class="hamburger hamburger-squeeze" type="button" data-toggle="aside" aria-label="Menu" aria-controls="navigation"><span class="hamburger-box"><span class="hamburger-inner"></span></span></button> <!-- /toggle menu -->
            <!-- .btn-account -->
            <button class="btn-account d-flex d-md-none" type="button" data-toggle="collapse" data-target="#dropdown-aside"><span class="user-avatar user-avatar-lg"><img src="http://localhost:81/carte/assets/epencia.jpg" alt=""></span> <span class="account-icon"><span class="fa fa-caret-down fa-lg"></span></span> <span class="account-summary"><span class="account-name">Menu Principal</span> <span class="account-description">Epencia Manager</span></span></button> <!-- /.btn-account -->
            <!-- .dropdown-aside -->
            <div id="dropdown-aside" class="dropdown-aside d-md-none collapse">
              <!-- dropdown-items -->
              <div class="pb-3">
                <a class="dropdown-item" href="http://localhost:81/carte/search/utilisateur/connexion"><span class="dropdown-icon oi oi-person"></span> Connexion</a> <a class="dropdown-item" href="auth-signin-v1.html"><span class="dropdown-icon oi oi-account-logout"></span> Logout</a>
                <div class="dropdown-divider"></div><a class="dropdown-item" href="#!">Help Center</a> <a class="dropdown-item" href="#!">Ask Forum</a> <a class="dropdown-item" href="#!">Keyboard Shortcuts</a>
              </div><!-- /dropdown-items -->
            </div><!-- /.dropdown-aside -->
            <!-- .top-bar-brand -->
            <div class="top-bar-brand bg-primary">
              <a href="index-2.html"><img src="assets/images/brand-inverse.png" height="32" alt=""></a>
            </div><!-- /.top-bar-brand -->
          </header><!-- /.aside-header -->
          <!-- .aside-menu -->
